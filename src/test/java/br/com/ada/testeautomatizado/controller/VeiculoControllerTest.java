...
class VeiculoControllerTest {
    ...
    @Test
    @DisplayName("Deletar veiculo pela placa com sucesso")
    ...
    @Test
    @DisplayName("Retorna todos os veiculos")
    ...
    @Test
    @DisplayName("Atualiza um veiculo com sucesso")
    ...
    @Test
    @DisplayName("Retorna No Content ao atualizar um veiculo que não existe na base de dados")
